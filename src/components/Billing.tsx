...
//   return (
//     <div className="h-screen w-full bg-neutral-100 rounded-xl border flex-center">
//       <div className="rounded-3xl shadow-lg bg-white text-base p-4 w-80">
//         <p className="text-neutral-500">Transitions</p>
//         <div className="py-4 w-full flex flex-col gap-2">
//           {data.map(i=>(
//             <CardTab id={i.id} key={i.id} icon={i.icon} brand={i.brand} type={i.type} price={i.price} openId={openId} setOpenId={setOpenId}/>
//           ))}
//         </div>
//         <button className="flex-center bg-neutral-200 rounded-xl px-4 py-2 w-full gap-1">All Transitions  <FaArrowRight size={16}/></button>
//       </div>
//     </div>
//   )
// }
...
//     <div onClick={handleOpen} className={`w-full hover:bg-neutral-100 p-2 rounded-xl ${openId ==  id || null  ? "display" : "hidden"}`}>
//       <div className={`flex w-full gap-2 ${open ? "flex-col" : ""}`}>
//         {/* icon div */}
//         <div style={{width: open ? "100%" : ""}} className='flex justify-between w-fit'>
//           <motion.span layout className={`p-2 bg-black ${open ? "rounded-xl" : "rounded-full"}`}>{icon}</motion.span>
//           {
//             open && ( <button onClick={handleClose} className='bg-black rounded-full p-1 w-fit h-fit hover:bg-black/50'><IoClose color='white' size={16}/></button> )
//           }
//         </div>
//         {/* text div */}
//         <motion.div layout className='w-full flex-between'>
//           <div>
...
//               <div className='border-y-2 border-dotted py-2'>
//                 <p>#54325</p>
//                 <p>September 10</p>
//                 <p>02:11 am</p>
//               </div>
...
//                 <p>XXXX 9342 <span className='uppercase italic text-black font-bold'>visa</span></p>
//               </div>
//             </div>
//           )
//         }
...
// Corrected imports to use the main 'react-icons' path for all icons
